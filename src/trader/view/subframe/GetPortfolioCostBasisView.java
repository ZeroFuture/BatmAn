...
/**
 * This is the GetPortfolioCostBasisView class.
 */
public class GetPortfolioCostBasisView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private JButton hint;
  private final String[] fieldLabel = {FieldName.GET_PORTFOLIO_COST.getMsg()};
  private final Form form = new Form(fieldLabel);

  /**
   * Constructor for GetPortfolioCostBasisView.
   *
   * @param caption caption.
   */
  public GetPortfolioCostBasisView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.GET_PORTFOLIO_COST_BASIS_SUBMIT.getMsg());

    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.GET_PORTFOLIO_COST_BASIS_BACK.getMsg());
