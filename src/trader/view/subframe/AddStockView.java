...
/**
 * The AddStockView fot GUI view.
 */
public class AddStockView extends JFrame implements GuiView {
  ...
  /**
   * The constructor of AddStockView.
   *
   * @param caption the title
   */
  public AddStockView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.ADD_STOCK_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.ADD_STOCK_BACK.getMsg());
