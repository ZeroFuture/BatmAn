...
/**
 * SavePortfolioView class.
 */
public class SavePortfolioView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private JButton hint;
  private final String[] fieldLabel = {FieldName.PORTFOLIO_NAME_SAVE.getMsg()};
  private final Form form = new Form(fieldLabel);

  /**
   * Constructor for SavePortfolioView.
   *
  ...
  public SavePortfolioView(String caption) {
    ...
    submit.setActionCommand(FieldName.SAVE_PORTFOLIO_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.SAVE_PORTFOLIO_BACK.getMsg());
