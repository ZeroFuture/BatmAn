...
/**
 * The BuyStockWithCommissionView view for GUI view.
 */
public class BuyStockWithCommissionView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private JButton hint;
  private final String[] fieldLabel = {FieldName.COMMISSION_FEE.getMsg(),
          FieldName.TICKET_SYMBOL.getMsg(), FieldName.DATE_OF_PURCHASE.getMsg(),
          FieldName.VOLUME_NUMBER.getMsg(), FieldName.PORTFOLIO_NAME.getMsg()};

  private final Form form = new Form(fieldLabel);

  /**
   * The constructor of BuyStockWithCommissionView.
   *
   * @param caption title
   */
  public BuyStockWithCommissionView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.BUY_STOCK_WITH_COMMISSION_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.BUY_STOCK_COMMISSION_BACK.getMsg());
