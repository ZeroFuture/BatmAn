...
/**
 * RetrieveStrategyView class.
 */
public class RetrieveStrategyView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private JButton hint;
  private final String[] fieldLabel = {FieldName.STRATEGY_NAME_RETRIEVE.getMsg()};
  private final Form form = new Form(fieldLabel);

  /**
   * Constructor RetrieveStrategyView.
   *
   * @param caption caption.
   */
  public RetrieveStrategyView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.RETRIEVE_STRATEGY_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.RETRIEVE_STRATEGY_BACK.getMsg());
    hint = new JButton(FieldName.CHECK_CURRENT_STRATEGY_ENTER.getMsg());
    hint.setActionCommand(FieldName.CHECK_CURRENT_STRATEGY_ENTER.getMsg());
