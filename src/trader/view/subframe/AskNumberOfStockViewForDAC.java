...
/**
 * The AskNumberOfStockViewForDAC is a view class for GUI View.
 */
public class AskNumberOfStockViewForDAC extends JFrame implements GuiView {
  ...
  /**
   * The constructor of AskNumberOfStockViewForDAC.
   *
   * @param caption title
   */
  public AskNumberOfStockViewForDAC(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.DAC_ASK_NUMBER_OF_STOCK_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.DAC_ASK_NUMBER_OF_STOCK_BACK.getMsg());
