...
/**
 * SaveStrategyView class.
 */
public class SaveStrategyView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private JButton hint;
  private final String[] fieldLabel = {FieldName.STRATEGY_NAME_SAVE.getMsg()};
  private final Form form = new Form(fieldLabel);

  /**
   * Constructor for SaveStrategyView.
   *
   * @param caption caption.
   */
  public SaveStrategyView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.SAVE_STRATEGY_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.SAVE_STRATEGY__BACK.getMsg());
