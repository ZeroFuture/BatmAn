 ...
 * EnterWeight Class.
 */
public class EnterWeight extends JFrame implements GuiView {
  private JButton submit;
  private Form form;

  /**
   * Constructor for EnterWeight.
   * @param size size.
   * @param caption caption.
   */
  public EnterWeight(int size, String caption) {
    super(caption);
    String[] fieldLabel = new String[size];
    for (int i = 0; i < size; i++) {
      fieldLabel[i] = FieldName.ENTER_WEIGHT.getMsg();
    }
    ...
    submit.setActionCommand(FieldName.TYPE_WEIGHT_SUBMIT.getMsg());
