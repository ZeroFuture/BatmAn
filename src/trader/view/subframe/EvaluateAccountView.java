...
/**
 * The EvaluateAccountView view for GUI view.
 */
public class EvaluateAccountView extends JFrame implements GuiView {
  private JButton submit;
  private JButton back;
  private final String[] fieldLabel = {FieldName.EVALUATE_TIME.getMsg()};
  private final Form form = new Form(fieldLabel);

  /**
   * Constructor for EvaluateAccountView.
   *
   * @param caption caption.
   */
  public EvaluateAccountView(String caption) {
    super(caption);
    ...
    submit.setActionCommand(FieldName.EVALUATE_ACCOUNT_SUBMIT.getMsg());
    back = new JButton(FieldName.BACK.getMsg());
    back.setActionCommand(FieldName.EVALUATE_ACCOUNT_BACK.getMsg());
